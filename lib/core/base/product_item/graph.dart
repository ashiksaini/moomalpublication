...
class Graph {
  ...
  factory Graph.fromJson(Map<String, dynamic> json) => Graph(
        ...
        isPartOf: json['isPartOf'] == null ? null : IsPartOf.fromJson(json['isPartOf'] as Map<String, dynamic>),
        datePublished: json['datePublished'] as String?,
        dateModified: json['dateModified'] as String?,
        breadcrumb: json['breadcrumb'] == null ? null : Breadcrumb.fromJson(json['breadcrumb'] as Map<String, dynamic>),
        inLanguage: json['inLanguage'] as String?,
        potentialAction: (json['potentialAction'] as List<dynamic>?)?.map((e) => PotentialAction.fromJson(e as Map<String, dynamic>)).toList(),
        itemListElement: (json['itemListElement'] as List<dynamic>?)?.map((e) => ItemListElement.fromJson(e as Map<String, dynamic>)).toList(),
