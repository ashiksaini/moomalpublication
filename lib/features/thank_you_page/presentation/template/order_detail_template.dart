  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Padding(
          padding:
              EdgeInsets.only(left: 10.h, right: 14.h, top: 10.v, bottom: 6.v),
          child: Column(
            ...
            children: [
              ...
              // spaceTextBold(
              //     leftText: 'total'.tr, rightText: orderSuccessResponse.total, context: context),
              // Divider(
              //   height: 1.h,
              //   color: AppColors.grey,
              // ),
              spaceTextBold(
                  ...
                  rightText: orderSuccessResponse.paymentMethod ?? "online".tr,
                  context: context),
              Divider(
                height: 1.h,
                color: AppColors.grey,
